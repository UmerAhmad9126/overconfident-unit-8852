     ...
     <div id="dropdown">
          <ul>
               <li>SHOP <i class="fa-solid fa-caret-down"></i>
                    <ul>
                         <li><a href="../allfruit/allfruits.html">ALL FRUITS</a></li>
               ...
               <li id="grow_link">GROW</li>
          </ul>
     </div>
     <div id="logo">
     <a href="../index.html"><img src="https://cdn.shopify.com/s/files/1/0449/5225/6667/files/website-logo_400x.png?v=1614326029" alt="logo"></a> 
     </div>
     <div id="funtn">
          ...
          <div id="EnableLogin"><a href="./login/login.html"><i class="fa-solid fa-user"></i></a></div>
          <div><a href="../cart/cart.html"><i class="fa-solid fa-bag-shopping"></i></a></div>
     </div>
</div>
<!-- <div class="dropdown"> -->
